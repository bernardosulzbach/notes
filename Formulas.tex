...
Therefore, $p_C - .4p_E - .6p_S = 0$. Similar equations can be obtained from the
other two lines.
...
HTTP status codes convey the reulst of the attempts of the server to satisfy the request
\begin{itemize}
