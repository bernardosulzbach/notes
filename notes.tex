...
\[\text{sign} \times \text{significant} \times 2^\text{exponent}\]
...
In order to convert the decimal representation of a real number to an IEEE 754 number the following algorithm may be used.
\begin{enumerate}
...
\item The biggest power of two less than or equal to the absolute value is 4.
...
\item The biggest power of two less than or equal to the absolute value is 128.
...
Convert \texttt{0 10001101 10000000000000000000000} from IEEE 754 single
