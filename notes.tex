...
\begin{center}
    \begin{tabular}{ |c|c|c| }
        ...
        \(\sqrt{x^2 - a^2}\)
          & \(x = a\sec\theta\)
          & \(0 \le \theta < \frac{\pi}{2} \cup \pi \le \theta < \frac{3\pi}{2}\) \\
        \hline
    \end{tabular}
\end{center}
...
limits.  As when \(x = 0\) \(\sin x = 0\), then \(\theta = 0\).  When \(x =
a\), \(\sin \theta = 1\), then \(theta = \pi / 2\).

\begin{align*}
    4 \int_{0}^{\frac{\pi}{2}} \frac{b}{a} \sqrt{a^2 - x^2} \dif x
    &= \frac{4b}{a} \int_{0}^{\frac{\pi}{2}} \sqrt{a^2 - x^2} a \cos \theta \dif \theta \\
