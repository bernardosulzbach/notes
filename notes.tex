...
In a datagram network, routing decisions are must be made for every data packet since the best route may have changed since last time.
...
Either choice tends to improve the delay and also reduce the amount of bandwidth consumed per packet, which tends to improve the overall network throughput as well \cite[p.~363]{computer-networks-tanenbaum-2012}.
